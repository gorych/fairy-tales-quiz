    ...
    companion object {
        private val items: List<Item> = listOf(
            ...
            Item(
                ...
                hints = listOf("В этой фразе 3 одинаковых слова.", "Первое слово 'мирись'.")
            ),
            Item(
            ...
            Item(
                ...
                hints = listOf(
                    "В этом слове 5 букв.",
                    "Это слово наинается на букву 'Е'.",
            ...
            Item(
                ...
                hints = listOf("Он живёт с курами.", "У него есть гребень.", "Он говорит 'ку-ка-ре-ку'.")
            ),
        )
