...
import org.gorych.alice.skill.fairytail.quiz.Quiz.Item.Level.*

class Quiz {

    data class Item(val level: Level, val question: String, val answers: List<String>, val hints: List<String>) {
        enum class Level {
            EASY,
            MEDIUM,
            HARD
